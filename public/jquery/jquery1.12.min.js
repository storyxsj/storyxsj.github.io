	...
	*/
	if(parseFloat(l)>parseFloat(_LH)){//First找低点
		...
		if(_countL == 3){
			...
			*/
			...
			console.info("[笔-开始]"+date+" "+c+"确认低点->"+dateArr[_Li]+" "+lArr[_Li]);
	...
	if(parseFloat(h)<parseFloat(_HL)){//First找高点
		...
		if(_countH == 3){
			...
			console.info("[笔-开始]"+date+" "+c+"确认高点->"+dateArr[_Hi]+" "+hArr[_Hi]);
		...
		if(_findHL){//找高点
			...
			if(parseFloat(h)<parseFloat(_HL)){
				...
				if(_countH == 3){
					...
					console.info("[笔]"+date+" "+c+"确认高点->"+dateArr[_Hi]+" "+hArr[_Hi]);
					_countL = 0;
					list1.push(dateArr[_Hi]);
					list2.push(hArr[_Hi]);
			...
			if(parseFloat(l)>parseFloat(_LH)){
				...
				if(_countL == 3){
					...
					console.info("[笔]"+date+" "+c+"确认低点->"+dateArr[_Li]+" "+lArr[_Li]);
					_countH = 0;
					list1.push(dateArr[_Li]);
					list2.push(lArr[_Li]);
